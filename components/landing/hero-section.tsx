...
export default function HeroSection() {
  return (
    <section className="py-20 md:py-28 bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="relative mx-auto w-full max-w-lg">
              ...
              />
              <motion.div 
                className="absolute -bottom-4 -right-4 h-72 w-72 bg-blue-500/5 rounded-full filter blur-3xl opacity-70"
                animate={{ 
                  scale: [1, 1.2, 1],
                  opacity: [0.7, 0.5, 0.7] 
                }}
              ...
              />
              <motion.div 
                className="relative shadow-2xl rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800"
